...
import BannerLight from '../public/img/home4/home4-banner-img-light.png';
import BannerDark from '../public/img/home4/home4-banner-img-dark.png';
import AboutHalfCircle from '../public/img/home4/about-half-circle-img.jpg';
import ArgentinaFlag from '../public/img/home4/argentina-flag.jpg';
  ...
  return (
    <main>
      ...
      <div className="home4-banner-section mb-130">
        <Image src={BannerLight} alt="" className="banner-img light" />
        <Image src={BannerDark} alt="" className="banner-img dark" />
        <div className="container">
          <div className="row justify-content-end">
            <div className="col-xl-10">
              <div className="banner-wrapper">
                <h1>Comunidad <br /><span>Programadores</span> Argentina</h1>
                <div className="banner-content-and-btn">
                  <p>
                    Un espacio donde conectar con personas IT de nuestro pais. Becas, recursos, desarrolladores, cursos, ofertas laborales, entre otra informacion. 
                    <br />Comunidad sin fines de lucro.
                  </p>
        ...
        <ul className="social-list">
          <li>
            <a target='_blank' href="https://www.linkedin.com/company/programadores-argentina"><i className="bx bxl-linkedin"></i></a>
          </li>
          <li>
            <a target='_blank' href="https://www.instagram.com/programadores_argentina/"><i className="bx bxl-instagram"></i></a>
          </li>
          <li>
            <a target='_blank' href="https://t.me/programadores_argentina"><i className="bx bxl-telegram"></i></a>
          </li>
        </ul>
        <div className="scroll-text">
          <h2>Un espacio para conectar programadores</h2>
        </div>
      </div>
      ...
      <div className="home4-about-section mb-130" id="about-section">
        <div className="container">
          <div className="row align-items-center mb-110">
            <div className="col-xl-9 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="about-content-wrap">
                <div className="about-section-title mb-40">
                  ...
                  <h2>
                    Conecta con personas que comparten tu misma pasión 💻
                  </h2>
                  <p>Además de la red de contactos, ofrecemos recursos, becas y cursos
                    que te permitirán mantener tus habilidades actualizadas y seguir creciendo en tu carrera.</p>
                </div>
                <a href="#stack" className="explore-btn">Leer nuestro stack
            ...
            <div className="col-xl-3 wow animate fadeInRight" data-wow-delay="400ms" data-wow-duration="1500ms">
          ...
          <div className="about-coundown-area">
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-4 col-md-4 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div className="single-countdown">
                  <div className="number">
                    <h2 className="counter">46</h2>
                    <span>K</span>
                  </div>
                  <div className="content">
                    <p>Miembros en LinkedIn</p>
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-4 d-flex justify-content-center wow animate fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                <div className="single-countdown">
                  <div className="number">
                  ...
                  <div className="content">
                    <p>Miembros en Instagram</p>
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-4 d-flex justify-content-center wow animate fadeInUp" data-wow-delay="800ms" data-wow-duration="1500ms">
                <div className="single-countdown">
                  <div className="flag">
                    <Image src={ArgentinaFlag} alt="flag argentina" />
                  </div>
                </div>
              </div>
            </div>
